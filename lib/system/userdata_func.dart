...
void storeStarData() async{
    saveList(date_star, 'date_star');
    saveList(title_star,'title_star');
    saveList(context_star, 'context_star');
    saveList(intelligence_star,'intelligence_star');
    saveList(used_time_star,'used_time_star');
    saveList(score_star, 'score_star');
}
void loadStarData() async{
  readList(date_star, 'date_star');
  readList(title_star,'title_star');
  readList(context_star, 'context_star');
  readList(intelligence_star,'intelligence_star');
  readList(used_time_star,'used_time_star');
  readList(score_star, 'score_star');
}
