...
class piano_serenade extends StatefulWidget {
  const piano_serenade({Key? key}) : super(key: key);

  @override
  piano_serenadeState createState() => piano_serenadeState();
}

class piano_serenadeState extends State<piano_serenade> with WidgetsBindingObserver {
  late Timer _timer;
  ...
  final _playlist = ConcatenatingAudioSource(children: [
    ...
    if (kIsWeb ||
      ...
      ClippingAudioSource(
        child: AudioSource.asset('assets/audio/Piano_Serenade.mp3'),
        tag: AudioMetadata(
          album: "Piano_Serenade",
          title: "天门",
          artwork:
