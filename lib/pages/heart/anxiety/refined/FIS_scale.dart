...
import 'package:heart_voyage/pages/heart/anxiety/refined/FIS_check.dart';
import 'package:heart_voyage/pages/heart/anxiety/refined/FIS_instruction.dart';
      ...
      body: SafeArea(
        child: ListView(
          children: [
            ...
            Divider(),
            CreateFIS_Scale(question: '1.把过去我觉得羞耻的事情告诉他(她)，我会感到不舒服'),
            Divider(),
