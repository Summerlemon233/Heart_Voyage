...
class CreateAASR_Scale extends StatefulWidget {
  ...
  CreateAASR_Scale({Key? key, required this.question,required this.mode,required this.mode1}) : super(key: key);
      ...
      body: SafeArea(
        child: ListView(
          children: [
            ...
            Divider(),
            CreateAASR_Scale(question: '4.我发现别人并不愿像我希望的那样亲近我',mode:1,mode1:3),
            Divider(),
            CreateAASR_Scale(question: '5.能依赖别人让我感到很舒服',mode:1,mode1:2),
            Divider(),
            CreateAASR_Scale(question: '6.我不在乎别人太亲近我',mode:1,mode1:1),
            Divider(),
            CreateAASR_Scale(question: '7.我发现当我需要别人帮助时,没人会帮我',mode:2,mode1:2),
            Divider(),
            CreateAASR_Scale(question: '8.和别人亲近使我感到有些不舒服',mode:2,mode1:1),
            Divider(),
            CreateAASR_Scale(question: '9.我时常担心情侣不想和我待在一起',mode:1,mode1:3),
            Divider(),
            CreateAASR_Scale(question: '10.当我对别人表达我的情感时,我害怕他们与我的感觉会不一样',mode:1,mode1:3),
            Divider(),
            CreateAASR_Scale(question: '11.我时常怀疑情侣是否真正关心我',mode:1,mode1:3),
            Divider(),
            CreateAASR_Scale(question: '12.我对与别人建立亲密的关系感到很舒服',mode:1,mode1:1),
            Divider(),
            CreateAASR_Scale(question: '13.当有人在情感上太亲近我时,我感到不舒服',mode:2,mode1:1),
            Divider(),
            CreateAASR_Scale(question: '14.我知道当我需要别人帮助时,总有人会帮我',mode:1,mode1:2),
            Divider(),
            CreateAASR_Scale(question: '15.我想与人亲近,但担心自己会受到伤害',mode:1,mode1:3),
            Divider(),
            CreateAASR_Scale(question: '16.我发现我很难完全信赖别人',mode:2,mode1:2),
            Divider(),
            CreateAASR_Scale(question: '17.情侣想要我在情感上更亲近一些,这常使我感到不舒服',mode:2,mode1:1),
            Divider(),
            CreateAASR_Scale(question: '18.我不能肯定,在我需要时，总找得到可以依赖的人',mode:2,mode1:2),
            Divider(),
            SizedBox(
              height: 10,
            ),
